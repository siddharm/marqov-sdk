#!/usr/bin/env python3
"""
VQE H₂ benchmark on Rigetti Ankaa-3 using raw Braket SDK.
...
S3_BUCKET = "amazon-braket-marqov-dev-us-west-1"
S3_PREFIX = "benchmarks/raw-sdk/vqe-rigetti"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + Rigetti Ankaa-3")
    print("=" * 60)
