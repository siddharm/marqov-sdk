#!/usr/bin/env python3
"""
VQE H₂ benchmark on IonQ Harmony using raw Braket SDK.
...
Cost estimate: ~$150 per run (expensive!)
"""
...
S3_PREFIX = "benchmarks/raw-sdk/vqe-ionq"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + IonQ Harmony")
    print("=" * 60)
    print(f"Device: IonQ Harmony")
    print(f"Qubits: 2")
