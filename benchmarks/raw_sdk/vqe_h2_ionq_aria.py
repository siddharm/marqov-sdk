#!/usr/bin/env python3
"""
VQE H₂ benchmark on IonQ Aria using raw Braket SDK.
...
Cost estimate: ~$300 per run (very expensive!)
"""
...
S3_PREFIX = "benchmarks/raw-sdk/vqe-ionq_aria"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + IonQ Aria")
    print("=" * 60)
    print(f"Device: IonQ Aria")
    print(f"Qubits: 2")
