#!/usr/bin/env python3
"""
VQE H₂ benchmark on IQM Emerald using raw Braket SDK.
...
S3_BUCKET = "amazon-braket-marqov-dev-eu-north-1"
S3_PREFIX = "benchmarks/raw-sdk/vqe-iqm_emerald"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + IQM Emerald")
    print("=" * 60)
    print(f"Device: IQM Emerald")
    print(f"Qubits: 2")
    ...
    for i in range(2):
        ...
        results.append(BenchmarkResult(
            name="vqe_h2_raw_sdk_iqm_emerald",
            run_number=i + 1,
