#!/usr/bin/env python3
"""
VQE H₂ benchmark on IQM Garnet using raw Braket SDK.
...
S3_PREFIX = "benchmarks/raw-sdk/vqe-iqm"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + IQM Garnet")
    print("=" * 60)
    print(f"Device: IQM Garnet")
    print(f"Qubits: 2")
