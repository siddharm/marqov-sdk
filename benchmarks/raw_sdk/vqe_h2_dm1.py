#!/usr/bin/env python3
"""
VQE H₂ benchmark on DM1 (Density Matrix Simulator) using raw Braket SDK.
...
S3_PREFIX = "benchmarks/raw-sdk/vqe-dm1"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + DM1 (Density Matrix Simulator)")
    print("=" * 60)
