#!/usr/bin/env python3
"""
VQE H₂ benchmark on TN1 (Tensor Network Simulator) using raw Braket SDK.
...
S3_PREFIX = "benchmarks/raw-sdk/vqe-tn1"
...
def main():
    print("VQE H₂ Benchmark - Raw SDK + TN1 (Tensor Network Simulator)")
    print("=" * 60)
